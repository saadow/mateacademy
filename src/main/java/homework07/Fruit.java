...
public class Fruit implements Serializable {
	...
	public Fruit(FruitType apple, int dayToLive, LocalDate of, int price, Object vitamins) {
	}
	...
	// checkable
	public void setNewPriceChecked(int daysToExpire) {
		try {
			int newPrice = price - price / daysToExpire;
			this.price = newPrice;
	...
	// uncheckable
	public void setNewPriceUnchecked() {
		try {
			...
			System.out.println("The new price integer is " + number);
			scnr.close();
			this.price = number;
